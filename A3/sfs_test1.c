 ...
 */
#define MAX_FNAME_LENGTH 15   /* Assume at most 16 characters (16.3) */
 ...
 */
#define MAX_FD 16  // max file you can open
 ...
 * reduce this value.
 */
#define MAX_BYTES 15000 /* Maximum file size I'll try to create */
